!(function($) {
    ...
    getData = function(module) {
        var ticketFieldsToDisplay = ["id", "requester_id", "created_at", "updated_at", "subject", "cc_email", "ticket_type", "description_html", "status_name"];
            ...
            .then(function(data) {
                ...
                if (_data) {
                    $.each(_data, function(_k, _v) {
                        // id, requester_id, created_at, updated_at, subject, cc_email, ticket_type, description_html, status_name
                        if(ticketFieldsToDisplay.includes(_k)) {
                            $label = $("<label>");
